let general = [
    ...
    },
    {
        ...
        content: `Send a mail to help@afiaanyi.com, or call us on 01-0000000 or 08030000000 , chat with us or tweet at us @afiaanyi`
    },
    {
    ...
    },
    {
        ...
        content: `We have our Head Office in Anambra and a Customer Experience center. Click here to view our Call Center Operational Hours.`
    }
];
...
window.addEventListener("load", function () {
    ...
    for (let i = 0; i < general.length; i++) {
        ...
        <div class="faq">
            ...
            <h3 class="faq__title">
                ${general[i].title}
                <img class="faq__arrow faq__arrow--opened" src="resources/img/arrow__down.svg">
            </h3>
...
let cardIcons = [
    ...
    "resources/img/services-agreement.svg",
